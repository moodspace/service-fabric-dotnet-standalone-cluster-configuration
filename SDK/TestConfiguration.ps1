...
$argList = @($DeployerBinPath, $ServiceFabricPowershellModulePath, $ClusterConfigFilePath, $OldClusterConfigFileAbsolutePath, $MicrosoftServiceFabricCabFileAbsolutePath)
Powershell -Command {
    param (
        [Parameter(Mandatory=$true)]
        $DeployerBinPath,
    ...
    Try 
    {
        Test-ServiceFabricConfiguration -ClusterConfigurationFilePath $ClusterConfigFilePath -OldClusterConfigurationFilePath $OldClusterConfigFilePath -FabricRuntimePackagePath $MicrosoftServiceFabricCabFileAbsolutePath
    }
    Catch
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUP63gd6gsJBMaAnE0I0LbOeuV
# prqgghWDMIIEwzCCA6ugAwIBAgITMwAAAMZ4gDYBdRppcgAAAAAAxjANBgkqhkiG
...
# kU2yb0yflIA3qsutLmHraDrLejBaBgorBgEEAYI3AgEMMUwwSqAsgCoAVABlAHMA
# dABDAG8AbgBmAGkAZwB1AHIAYQB0AGkAbwBuAC4AcABzADGhGoAYaHR0cDovL3d3
# dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAG2/6HP/JUyJjBnz8uBH
# ZncS0PoblRpafAklWguBgue8g5TNBuEkPiV3QmrY603gL5NC5duGFpG6p+TaUwCn
# SfNoh9Hs+mNepI6ikvf4e9oRHkgU+b+NU2S1s/Y0Y1h5RuIapGl8yd0XNoP5mLPd
# rk1QPkkzwjDmMBjcoeoxGZGL+sNl+PgB+Amyy3UxV0IE6CuzpLrLrC8+Wiitlagv
# 40IPQ2TTmKGdRAtirhmjMfSWfPHw2OioyenuwP1z2IG++i/Lvltq0oxC7wLgzx+/
# cbSJoz5JCrw0pbYwvhc/xLCXiBdWH5dcOMAAb43IW/GFrCtMbXQyJH0Qa83N+g+L
# 4emhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UEBhMC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNzA3MjYy
# MjMyMTFaMCMGCSqGSIb3DQEJBDEWBBRxdQypCibvV6efDCOFeExgq7zrOTANBgkq
# hkiG9w0BAQUFAASCAQBOR/60Y5UkyZMLStowcxTBFMeJsdP7V3JG1Vli4D/gCbcY
# fnBLnxhaD0dSvAvwZKSZF9bw41UrE370inIi6pvFDgBx3a24zuHNAS1myVyiNkjA
# 5s93jbFVYfRTYLL7ejbSx29jLSqPIf6J54ZpqR22VzRoz/Tp0HFYDDc7KueRcFrR
# iLnCclXUDKr/EDFXeq4BPXf4t3Nulk7uP1PFh9kmGg5AnHhLQP+Xid2WS6nSluxC
# brwwDBbUUxvTxa8ZjaD+0OXuP7oletuve1YAbGYJMcrVALqU+dhf+Q5GUH3mPq3i
# 4Qb0zV8Ri9O0T5M1mqrMgkTCBfHfQfDCWmTDuGBW
